	          ...
	          _react2.default.createElement(
	            _2.default,
	            {
	              ...
	              onChange: function onChange(e) {
	                return _this.setState({ single: e.target.value });
	              } },
	            this.renderOptions()
	          )
	        ),
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { multiple: true,
	              ...
	              onChange: function onChange(e) {
	                return _this.setState({ multi: e.target.value });
	              } },
	            this.renderOptions()
	          )
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NormalizedSelect = _require.NormalizedSelect;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactComponentWithPureRenderMixin = __webpack_require__(167);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
	
	var NormalizedSelect = exports.NormalizedSelect = _react2.default.createClass({
	  displayName: 'NormalizedSelect',
	  ...
	  onChange: function onChange(event) {
	    ...
	    this.props.onChange(_extends({}, event, {
